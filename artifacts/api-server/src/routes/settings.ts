...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  abstract_conference_theme: "Advancing One Health: Bridging Research, Surveillance, and Control of Ticks and Tick-Borne Diseases in Southeast Asia.",
  abstract_seat_topics: "Tick Biology and Ecology\nTick-Borne Pathogens and Diseases\nSurveillance and Public Health\nGenomics, Data Science and Emerging Technologies\nTick Control and Management",
  abstract_msptm_topics: "Tropical and Infectious Diseases\nVector Biology and Medical Entomology\nMicrobiology and Parasitology\nDrug, Insecticide and Antibiotic Resistance\nOther Related Topics",
